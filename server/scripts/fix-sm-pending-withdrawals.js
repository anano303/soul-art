...
async function migrate() {
  ...
  for (const manager of managers) {
    ...
    if (pendingTx) {
      ...
      console.log('  This withdrawal was made before transaction logging was added.');
      console.log('  Options:');
      console.log('  1. Check BOG Business Online if there is a pending document');
      console.log('  2. Reset salesPendingWithdrawal to 0 (refund to available balance)');
      ...
      console.log('  ✓ Reset complete. Manager can now request withdrawal again.');
    }
  }
