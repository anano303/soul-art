...
• როცა ბონუსი მიაღწევს 50 ლარს შეგიძლია გამოიტანო`,
    ...
    profile: {
      ...
      sellerLogo: "თქვენი ბრენდის სურათი (არასავალდებულო)",
      sellerLogoUpload: "ატვირთეთ ფოტო ან ლოგო",
    ...
    admin: {
      ...
      geoTest: "გეოლოკაციის ტესტი",
      geoTestDesc: "შეამოწმეთ გეოლოკაციის სისტემა",
      loading: "იტვირთება...",
    ...
    auctions: {
      ...
      paid: "გადახდილია",
      payNow: "გადახდა",
      auctionWinner: "აუქციონის გამარჯვებული",
      winningBid: "მოგებული ფასი",
      congratulations: "გილოცავთ! თქვენ მოიგეთ ეს აუქციონი!",
      proceedToPayment: "გადახდა",
      completePayment: "გადახდის დასრულება",
      wonAuction: "მოგებული აუქციონი",
      selectDeliveryZone: "აირჩიეთ მიწოდების ზონა",
      tbilisi: "თბილისი",
      tbilisiDesc: "თბილისის ფარგლებში მიწოდება",
      region: "რეგიონი",
      regionDesc: "საქართველოს რეგიონებში მიწოდება",
      artworkPrice: "ნამუშევრის ფასი",
      selectZone: "აირჩიეთ ზონა",
      confirmPayment: "გადახდის დადასტურება",
      paymentSuccess: "გადახდა წარმატებით დასრულდა!",
      paymentError: "გადახდის შეცდომა",
      notWinner: "თქვენ არ ხართ ამ აუქციონის გამარჯვებული",
      notEnded: "აუქციონი ჯერ არ დასრულებულა",
      alreadyPaid: "აუქციონი უკვე გადახდილია",
    ...
    footer: {
      ...
      referralInfo: "რეგისტრაცია",
      referralSub: "ინფლუენსერებისთვის / პარტნიორობისთვის",
      becomeSeller: "გახდი გამყიდველი",
      becomeSellerSub: "ხელოვანებისთვის",
      careers: "კარიერა",
    },
    ...
    home: {
      ...
      springCollection: {
        ...
        subtitle:
          "აღმოაჩინე ყვავილებით, ბუნებითა და სიცოცხლით სავსე ნამუშევრები — შთაგონება გაზაფხულის სილამაზისგან",
        viewAll: "ყველას ნახვა",
    ...
    auth: {
      ...
      lastName: "გვარი",
      companyName:
        "მაღაზიის ან/და ავტორის სახელი (რაც გინდათ გამოჩნდეს საიტზე)",
      phoneNumber: "ტელეფონის ნომერი",
      ...
      enterCompanyName: "მაგ: ხელოვნების სტუდია / გიორგი გიორგაძე",
      ...
      becomeSeller: "გახდი გამყიდველი",
      forInfluencers: "გახდი პარტნიორი",
      becomeSellerHint: "ხელოვანებისთვის",
      forInfluencersHint: "ინფლუენსერებისთვის / პარტნიორობისთვის",
...
• You can withdraw when bonus reaches 50 GEL`,
    ...
    profile: {
      ...
      sellerLogo: "Your Brand Image (Optional)",
      sellerLogoUpload: "Upload photo or logo",
    ...
    admin: {
      ...
      geoTest: "Geo Test",
      geoTestDesc: "Test geolocation system",
      loading: "Loading...",
    ...
    auctions: {
      ...
      tbilisi: "Tbilisi",
      tbilisiDesc: "Delivery within Tbilisi",
      region: "Region",
      regionDesc: "Delivery to Georgian regions",
      artworkPrice: "Artwork Price",
      selectZone: "Select zone",
      confirmPayment: "Confirm Payment",
      paymentSuccess: "Payment completed successfully!",
      paymentError: "Payment error",
      notWinner: "You are not the winner of this auction",
      notEnded: "Auction has not ended yet",
    ...
    footer: {
      ...
      referralInfo: "Registration",
      referralSub: "For influencers / partners",
      becomeSeller: "Become a Seller",
      becomeSellerSub: "For artists",
      careers: "Careers",
    },
    ...
    auth: {
      ...
      lastName: "Last Name",
      companyName: "Store / Author Name (displayed on site)",
      phoneNumber: "Phone Number",
      uploadLogo: "Upload Logo",
      idNumber: "ID Number/Company ID",
      accountNumber: "Account Number",
      ...
      enterCompanyName: "e.g. Art Studio / John Doe",
      ...
      becomeSeller: "Become a Seller",
      becomeSellerHint: "For artists",
      forInfluencers: "Become a Partner",
      forInfluencersHint: "For influencers / partners",
