    ...
    <div className="announcement-overlay">
      <div className="announcement-modal">
        ...
        <div className="announcement-body">
          <p>
            <strong>ძვირფასო ხელოვანებო</strong>
          </p>
          <p>
          ...
          <div className="announcement-action-box">
            ...
            <li> თუ თქვენი პროფილი რეგისტრირებულია და ნამუშევრების ნაწილი არ არის ხელმისაწვდომი, მოგვწერეთ კონტაქტის გვერდიდან ან facebook გვერდზე და აღვადგენთ ყველაფერს</li>
            <li>გადაამოწმეთ თქვენი ნამუშევრები თუ რომელიმე უკვე გაყიდულია, გთხოვთ წაშალეთ ისინი</li>
            </ul>
          </div>
