        ...
        {en ? (
          ...
          <>
            ...
            <p>
              ...
              თუ კონკრეტული სტილის, ზომის ან ბიუჯეტის ნამუშევარს ეძებ — სიამოვნებით
              დაგეხმარებით შესაფერისის მოძებნაში. ორიგინალი ნახატი ან ხელნაკეთი
              ნივთი ასევე დასამახსოვრებელი და პირადული საჩუქარია ახლობლისთვის,
              დაბადების დღეზე თუ განსაკუთრებულ დღესასწაულზე.
            </p>
          </>
        )}
      </div>
