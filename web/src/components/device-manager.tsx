    ...
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-lg font-semibold">{t('deviceManager.loggedInDevices')}</h3>
        ...
        {devices.length === 0 ? (
          <p className="text-gray-600">{t('deviceManager.noLoggedInDevices')}</p>
        ) : (
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className={`text-xs px-2 py-1 rounded ${
                        ...
                        {device.trusted ? `🔒 ${t('deviceManager.trusted')}` : `⚠️ ${t('deviceManager.notTrusted')}`}
                      </span>
                    </div>
