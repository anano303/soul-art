        ...
        {refCodeInfo?.salesRefCode ? (
          <div className="ref-code-display">
            ...
            <p className="ref-info">
              ეს ლინკი ან პრომო კოდი გაუგზავნე კლიენტებს. როცა ამ ლინკით შემოვლენ და იყიდიან,
              მიიღებ <strong>{balance?.commissionRate ?? 3}%</strong>{" "}
              საკომისიოს, ისინი მიიღებენ სპეციალურ ფასდაკლებებს შენი პრომო კოდის გამოყენებისას, პრომო კოდს საიტზე შემოსვლისთანავე წერენ ზედა მარჯვენა კუთხეში!
            </p>
          </div>
        ) : (
