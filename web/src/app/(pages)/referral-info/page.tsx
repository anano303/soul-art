...
export default function ReferralInfoPage() {
  ...
  const shareReferralInfo = async () => {
    const shareText = `🎨 SoulArt.ge-ზე შეგიძლია გამოიმუშავო თანხა!
          ...
          <div className="hero-content">
            ...
            <div className="hero-stats">
              <div className="stat-item">
                ...
                <div className="stat-label">სელერის რეფერალისთვის</div>
              </div>
              <div className="stat-item">
          ...
          <div className="benefits-grid">
            <div className="benefit-card">
              ...
              <p className="benefit-description">
                ქართველი მხატვრების და ხელოვანების უნიკალური ნამუშევრების
                პლატფორმა
              </p>
            </div>
            <div className="benefit-card">
        ...
        <section className="rules-section">
          ...
          <div className="rules-grid">
            <div className="rule-card">
              <h4>სელერის რეფერალი</h4>
              <ul>
                <li>5 ლარი ყველა მოწვეული სელერისთვის(გამყიდველისთვის)</li>
        ...
        <section className="faq-section">
          ...
          <div className="faq-grid">
            <div className="faq-item">
              ...
              <p>
                სელერის რეფერალისთვის ბონუსი ირიცხება მას შემდეგ, რაც ის
