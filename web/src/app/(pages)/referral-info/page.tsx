        ...
        <section className="how-it-works">
          ...
          <div className="steps-grid">
            ...
            <div className="step-card">
              ...
              <h3 className="step-title">გამოიღე ფული</h3>
              <p className="step-description">
          ...
          <div className="benefits-grid">
            <div className="benefit-card">
              ...
              <p className="benefit-description">
                ქართველი მხატვრების უნიკალური ნამუშევრების პლატფორმა
              </p>
            </div>
            <div className="benefit-card">
              <div className="benefit-icon">💰</div>
            ...
            <div className="benefit-card">
              ...
              <p className="benefit-description">
                ხელოვნების მოყვარულთა აქტიური კომუნიტი
              </p>
            </div>
            <div className="benefit-card">
              <div className="benefit-icon">🚀</div>
          ...
          <div className="rules-grid">
            <div className="rule-card">
              ...
              <ul>
                ...
                <li>ადმინისტრაციის მოწონება სავალდებულოა</li>
              </ul>
            </div>
            <div className="rule-card">
        ...
        <section className="faq-section">
          ...
          <div className="faq-grid">
            <div className="faq-item">
              ...
              <p>
                სელერი რეფერალისთვის ბონუსი ენაცვლება მას შემდეგ, რაც ის
            ...
            <div className="faq-item">
              ...
              <p>არა, შეგიძლია მოიწვიო ბოლამდე რამდენიც მეგობარი გსურს.</p>
            </div>
          </div>
        </section>
      </div>
